...
//   { id: 'cn-details', label: 'CN Details', icon: FileSpreadsheet, path: '/cn-details', roles: ['ADMIN', 'BILL VERIFY'] },
//   { id: 'bill-status', label: 'Bill Status', icon: Printer, path: '/bill-status', roles: ['ADMIN', 'ACCOUNTS'] },
//   { id: 'lr-details', label: 'LR Details', icon: Activity, path: '/lr-details', roles: ['ADMIN', 'AUDIT'] },
//   { id: 'pending-bill-generation', label: 'Pending Bill Generation', icon: AlertTriangle, path: '/pending-bill-generation', roles: ['ADMIN', 'AUDIT'] },
//   { id: 'bill-delete', label: 'Bill Delete', icon: FileText, path: '/bill-delete', roles: ['ADMIN', 'AUDIT'] },
//   { id: 'pod-report', label: 'POD Report', icon: FileSpreadsheet, path: '/pod-report', roles: ['ADMIN', 'ACCOUNTS', 'BILL VERIFY'] },
//   { id: 'cn-reports', label: 'CN Reports', icon: BarChart, path: '/cn-reports', roles: ['ADMIN', 'BILL VERIFY', 'ACCOUNTS'] },
...
//   // New menu items
//   { id: 'bill-generate-using-exel-upload', label: 'Bill Generate (Excel Upload)', icon: FileText, path: '/bill-generate-using-exel-upload', roles: ['ADMIN', 'ACCOUNTS'] },
//   { id: 'reports', label: 'Reports', icon: BarChart, path: '/reports', roles: ['ADMIN', 'AUDIT'] },
//   { id: 'bill-noc', label: 'Bill NOC', icon: FileText, path: '/bill-noc', roles: ['ADMIN', 'ACCOUNTS'] },
//   { id: 'assigned-vendor', label: 'Assigned Vendor', icon: Users, path: '/assigned-vendor', roles: ['ADMIN', 'VENDOR'] },
//   { id: 'posted-bill', label: 'Posted Bill', icon: FileSpreadsheet, path: '/posted-bill', roles: ['ADMIN', 'ACCOUNTS'] },
//   { id: 'posting-bill', label: 'Posting Bill', icon: FileSpreadsheet, path: '/posting-bill', roles: ['ADMIN', 'ACCOUNTS'] }
// ];
...
export const menuItems = [
  ...
  { id: 'lr-details', label: 'LR Details', icon: Activity, path: '/lr-details', roles: ['ADMIN', 'VENDOR', 'BRANCH'] },
