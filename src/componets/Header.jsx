...
//           <img src="/image/logo.png" alt="logo" className="h-14 w-32 rounded-lg" />
...
//               >
//                 <path d="M20 6H13" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
//                 <path d="M20 12H11" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
//                 <path d="M20 18H13" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
//                 <path d="M8 8L4 12L8 16" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
//               </svg>
//             </div>
//           </button>
//         </div>
...
//           className="bg-white hover:bg-black hover:text-white text-black px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm rounded-md"
//         >
//           Logout
//         </button>
