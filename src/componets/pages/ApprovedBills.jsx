...
const ApprovedBills = ({ isNavbarCollapsed }) => {
  ...
  const modalColumns = [
    ...
    {
        name: "Updated Crane",
        selector: (row) => row.BRANCH_CRANE || "N",
        sortable: true,
        wrap: true,
      },
      {
        name: "Updated Hydra",
        selector: (row) => row.BRANCH_HYDRA || "N",
        sortable: true,
        wrap: true,
      },
      {
        name: "Updated Chain Pulling",
        selector: (row) => row.BRANCH_CHAIN_PULLING || "N",
        sortable: true,
        wrap: true,
      },
      {
        name: "Updated HKM",
        selector: (row) => row.BRANCH_HKM || "N",
        sortable: true,
        wrap: true,
      },
      {
        name: "Updated Labour Expenses",
        selector: (row) => row.BRANCH_LABOUR_EXPENSES || "N",
        sortable: true,
        wrap: true,
      },
      {
        name: "Updates Other Expenses",
        selector: (row) => row.BRANCH_SPECIAL_VEHICLE || "N",
        sortable: true,
        wrap: true,
      },
      {
